...
def main():
    ...
    print("""
  ######################################
  # DDS Development Environment Setup #
  ######################################

  This script will create your DDS dev environment for you.
  ...
  This script will create two hard links on your system, both pointing to your DDS project folder:
    [Arma 3 installation directory]\\{} => DDS project folder
    P:\\{}                              => DDS project folder
